...
import zip.encoding.ZipEncoding;
import zip.encoding.ZipEncodingHelper;
import zip.extrafield.UnicodeCommentExtraField;
import zip.extrafield.UnicodePathExtraField;

import static zip.ZipLong.putLong;
import static zip.ZipShort.putShort;
import static zip.encoding.ZipEncodingHelper.UTF8_ZIP_ENCODING;
